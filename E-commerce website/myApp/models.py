...
class Product(models.Model):
    ...
    productId   = models.CharField(max_length=30) # 商品id
    longName    = models.CharField(max_length=150) # 商品名+规格
    storeNums   = models.CharField(max_length=30) # 库存
    #销量

    specifics    = models.CharField(max_length=50) # 规格
    sort         = models.CharField(max_length=30) # 排序
    marketPrice = models.CharField(max_length=30) # 超市价格
    price        = models.CharField(max_length=30) # 价格
    categoryId  = models.CharField(max_length=30) # 分组id
    childId    = models.CharField(max_length=30) # 子组id
    img          = models.CharField(max_length=200)# 商品图片
    keywords     = models.CharField(max_length=100) # 搜索关键字
    brandId     = models.CharField(max_length=30) # 品牌id
    brandName   = models.CharField(max_length=100) # 品牌名称
    safeDay     = models.CharField(max_length=30) # 保质期长度
    safeUnit    = models.CharField(max_length=30) # 保质期单位模式
    safeUnitDesc = models.CharField(max_length=30) # 保质期单位
...
class MainDescription(models.Model):
    ...
    class Meta():
        ...
        ordering = ["sort"]
#insert into MainDescription(categoryId,categoryName,sort,img,product1,product2,product3)values('','22057','22058','22062')
#分组
'''
分组表   categoriegroups
name            组名
...
class CategorieGroup(models.Model):
    name = models.CharField(max_length=20)
    categorieId = models.CharField(max_length=20,unique=True)
    sort = models.CharField(max_length=20)
...
class ChildGroup(models.Model):
    ...
    name = models.CharField(max_length=20)
    sort = models.CharField(max_length=20)
    categorie = models.ForeignKey('CategorieGroup',to_field='categorieId')
    isDelete = models.BooleanField(default=False)
    class Meta:
